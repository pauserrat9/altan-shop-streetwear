...
const Index = () => {
  return <div className="min-h-screen bg-background flex flex-col items-center justify-center">
      <div className="text-center space-y-16">
        {/* Logo */}
        <div>
          <img src={altanLogo} alt="AltanShop" className="h-12 w-auto mx-auto" />
        </div>
        ...
        <div className="space-y-4">
          ...
          <Link to="/hoodies" className="block text-lg font-serif text-foreground hover:text-primary hover:underline transition-colors duration-200 px-0 mx-0 my-0">
            shop hoodies
          </Link>
        </div>
      </div>
